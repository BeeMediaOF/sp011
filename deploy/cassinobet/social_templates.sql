-- Cassino Bet — 2 modelos de arte social (Feed 1080×1350) na identidade do blog.
...
-- A URL exibida é texto fixo: cassinobet.midia.run
-- Como rodar (VPS):
--   cd /opt/sp011
