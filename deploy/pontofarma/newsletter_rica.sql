...
--
-- (Alternativa: enviar as imagens pelo Admin → Newsletter e usar as URLs que ele
-- devolve.) Idempotente (guarda por nome da moldura / assunto). Campanha entra
-- como RASCUNHO. Requer a imagem do blog COM o modo full-bleed (email.ts).
-- ============================================================================
