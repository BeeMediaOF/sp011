      ...
      ) || $tpl$
{
  ...
  "blocks": [
    { "id": "search-pf-hero", "name": "Bem-vindo ao Ponto Farma", "width": "half", "order": 0, "color": "#18a957", "custom": true, "format": "search_card", "visible": true, "blockType": "search", "caption": "Buscar artigos, guias e temas...", "linkLabel": "✉️ Receba conteúdos exclusivos no seu e-mail — inscreva-se no fim da página.", "linkUrl": "#newsletter-pf-assine", "html": "<div style=\"color:#18a957;font-weight:800;letter-spacing:.08em;font-size:13px;text-transform:uppercase;margin-bottom:14px;\">Bem-vindo ao Ponto Farma</div><div style=\"font-size:36px;line-height:1.08;color:#0e2341;font-weight:800;margin-bottom:14px;\">Conteúdo estratégico para farmácias</div><div style=\"color:#6b7280;font-size:16px;line-height:1.5;\">Insights práticos sobre gestão, regulação, mercado e operação para tomar melhores decisões e fazer sua farmácia crescer.</div>" },
    { "id": "content-pf-destaques", "name": "", "width": "half", "order": 1, "color": "#0c8b46", "custom": true, "format": "magazine", "layout": "magazine", "source": "latest", "visible": true, "blockType": "content" },
