...
| `farodejogo` | farodejogo.midia.run | pt-BR, esporte (marca Faro de Jogo) | azul royal `#1c66bd` (escudo) + amarelo `#fcc419` (apito, **só como bloco com tinta navy** — sobre branco dá 1,64:1) + navy `#0b1526`, rodapé `#060d18` | Kit completo em `deploy/farodejogo/`; go-live pendente |
