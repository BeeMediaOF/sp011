 ...
 * uma tag que não está aqui nem no StarterKit, ela NÃO sobrevive. O teste
 * `editorBlocks.test.ts` roda o round-trip de verdade e é quem cobra isso.
 *
 ...
 * Espelhado em `central-web/src/components/editorBlocks.ts`.
 */
