...
const PT = {
  ...
  // ── Transferências (bloco da home + página /transferencias) ────────────
  // O path é código (um só para os 11 blogs); o rótulo é dado — no ksports
  // esta mesma página se chama "Transfers".
  "transfers.title": "POSSÍVEIS TRANSFERÊNCIAS",
  "transfers.pageTitle": "Possíveis transferências",
  "transfers.subtitle": "Rumores do mercado da bola acompanhados pela redação",
  "transfers.probability": "Probabilidade",
  "transfers.seeAll": "Ver todas as possíveis transferências",
  "transfers.empty": "Nenhuma transferência cadastrada no momento.",
  "transfers.search": "Buscar jogador",
  "transfers.allClubs": "Todos os clubes",
  "transfers.value": "Valor estimado",
  "transfers.marketValue": "Valor de mercado",
  "transfers.source": "Fonte",
  "transfers.date": "Data da informação",
  "transfers.age": "anos",
  "transfers.noResults": "Nenhum resultado para esta busca.",
  "transfers.count": "rumor(es)",
  "transfers.pos.goalkeeper": "Goleiro",
  "transfers.pos.defender": "Zagueiro",
  "transfers.pos.fullback": "Lateral",
  "transfers.pos.midfielder": "Meio-campista",
  "transfers.pos.attacking_mid": "Meia-atacante",
  "transfers.pos.winger": "Ponta",
  "transfers.pos.forward": "Atacante",
  "transfers.pos.coach": "Técnico",
...
const EN: Record<TKey, string> = {
  ...
  "transfers.title": "POSSIBLE TRANSFERS",
  "transfers.pageTitle": "Possible transfers",
  "transfers.subtitle": "Transfer market rumours tracked by our newsroom",
  "transfers.probability": "Probability",
  "transfers.seeAll": "See all possible transfers",
  "transfers.empty": "No transfers on record right now.",
  "transfers.search": "Search player",
  "transfers.allClubs": "All clubs",
  "transfers.value": "Estimated fee",
  "transfers.marketValue": "Market value",
  "transfers.source": "Source",
  "transfers.date": "Reported on",
  "transfers.age": "years old",
  "transfers.noResults": "No results for this search.",
  "transfers.count": "rumour(s)",
  "transfers.pos.goalkeeper": "Goalkeeper",
  "transfers.pos.defender": "Centre-back",
  "transfers.pos.fullback": "Full-back",
  "transfers.pos.midfielder": "Midfielder",
  "transfers.pos.attacking_mid": "Attacking midfielder",
  "transfers.pos.winger": "Winger",
  "transfers.pos.forward": "Forward",
  "transfers.pos.coach": "Manager",
