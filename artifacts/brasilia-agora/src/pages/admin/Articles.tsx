...
export default function Articles() {
  ...
  // Fila de reescrita: aqui só alimenta os badges "Na fila" da tabela — o card
  // de progresso/controles mora em Fontes RSS (RewriteQueueCard), visível
  // apenas quando a coleta local está ativa (o padrão da rede é central-push).
