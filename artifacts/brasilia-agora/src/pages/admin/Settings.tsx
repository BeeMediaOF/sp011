...
export default function Settings() {
            ...
            {loadingSettings ? (
              ...
              <>
                ...
                <div className={`${CARD} p-6`} style={CARD_SHADOW}>
                  ...
                  <button
                    onClick={() => setField("showImageCredit", !(settings.showImageCredit ?? true))}
                    className={`mt-3 flex items-center gap-3 px-4 py-3 rounded-xl border-2 transition-all w-full ${
                      (settings.showImageCredit ?? true)
                        ? "border-[#0B2A66] bg-[#0B2A66]/5 text-[#0B2A66]"
                        : "border-[#E2E8F0] text-[#94A3B8] hover:border-[#CBD5E1]"
                    }`}>
                    <Image size={18}/>
                    ...
                    <span className={`text-xs px-2.5 py-1 rounded-full font-semibold ${(settings.showImageCredit ?? true) ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-400"}`}>
                      {(settings.showImageCredit ?? true) ? t("cfg.enabledM") : t("cfg.disabledM")}
                    </span>
                  </button>
                </div>
  ...
  "article": {
    ...
    ...
        ...
        {/* ── PERMISSÕES (movidas para o modal de cada usuário) ── */}
          ...
          <div className="max-w-3xl space-y-4">
            <div className="bg-[#0B2A66] rounded-2xl p-6 text-white relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-lg font-bold">As permissões agora são por usuário</h2>
              </div>
              <p className="text-sm text-blue-200 leading-relaxed max-w-lg">
                Antes existia um único conjunto para todo o perfil Editor. Agora cada pessoa
                tem o seu: abra <strong>Usuários</strong>, clique no lápis e vá na sub-aba
                <strong> Permissões</strong> — vale também para o perfil Colunista.
              </p>
              <a href="/admin/usuarios"
                className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-xl bg-white text-[#0B2A66] text-sm font-semibold hover:opacity-90">
                Ir para Usuários
              </a>
            </div>
            <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
              ...
              <p className="text-[12px] text-amber-700 leading-relaxed">
                ...
                backend bloqueiam qualquer acesso não autorizado — cada um lendo o conjunto
                do usuário logado.
              </p>
            </div>
          </div>
