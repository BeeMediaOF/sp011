...
const SLOTS: {
...
}[] = [
  {
    key:     "topo",
    label:   "Topo",
    desc:    "Acima do conteúdo principal",
    dims:    "1115×264",
  ...
  },
  {
    key:     "rodape",
    label:   "Rodapé",
    desc:    "Banner no rodapé da página",
    dims:    "952×264",
  ...
  {
    key:     "slidebar_250",
    label:   "Slide Bar (Pequeno)",
    desc:    "Bloco lateral 300×250",
    dims:    "300×250",
  ...
  {
    key:     "slidebar_500",
    label:   "Slide Bar (Grande)",
    desc:    "Bloco lateral 300×500",
    dims:    "300×500",
